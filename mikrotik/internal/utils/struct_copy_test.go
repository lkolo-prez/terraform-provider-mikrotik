...
func TestCopyStruct(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			Int16:       20_000,
			Int32:       20_000_000,
			Int64:       20_000_000_000,
			Uint:        10,
			Uint8:       200,
			Uint16:      20_000,
			Uint32:      20_000_000,
			Uint64:      20_000_000_000,
		...
		},
		{
			...
			Int64:         tftypes.Int64Value(20_000_000_000),
			...
			Uint64:        tftypes.Int64Value(20_000_000_000),
			UnmappedField: tftypes.StringValue("unmapped field"),
		...
		},
		{
			...
			Int16:         tftypes.Int64Value(20_000),
			Int32:         tftypes.Int64Value(20_000_000),
			Int64:         tftypes.Int64Value(2_000_000),
			UnmappedField: tftypes.StringValue("unmapped field"),
				Boolean:       tftypes.BoolValue(true),
				IntList: tftypes.ListValueMust(tftypes.Int64Type,
					[]attr.Value{
