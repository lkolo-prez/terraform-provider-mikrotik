...
func (p *ProviderFramework) Resources(ctx context.Context) []func() resource.Resource {
	return defaultaware.WrapResources([]func() resource.Resource{
		...
		NewOspfAreaV7Resource,
		NewOspfInstanceV7Resource,
		NewOspfInterfaceTemplateV7Resource,
		NewPoolResource,
		NewRoutingFilterChainResource,
		NewRoutingFilterRuleResource,
		NewRoutingTableResource,
		NewSchedulerResource,
		NewScriptResource,
		NewSnmpResource,
		NewSnmpCommunityResource,
		NewSystemBackupResource,
		NewSystemLoggingResource,
		NewSystemLoggingActionResource,
		NewVlanInterfaceResource,
		NewWiFiAccessListResource,
		NewWiFiChannelResource,
		NewWiFiConfigurationResource,
		NewWiFiDatapathResource,
		NewWiFiSecurityResource,
